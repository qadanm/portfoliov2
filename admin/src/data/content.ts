...
export const headlines: Record<string, string> = {
  ...
  'ai-product-designer':
    'AI product designer. Built for the moments where AI earns a seat in the loop, not the moments where it gets pasted on.',
  'ux-product-lead':
...
export const summaries: Record<string, string> = {
  ...
  'design-engineer':
    'Design engineer working in the overlap. Built ChatOBD2 end to end with Claude Design and Claude Code. Maintain platform-level design systems at MagTek. Author CSS and components by hand against tokens that ship across many surfaces.',
  ...
  'ai-product-designer':
    'Product designer for AI-native systems. Founded ChatOBD2, where AI sits constrained in the middle of a deterministic pipeline rather than driving the experience. Designed and built the product, the marketing site, and the developer portal that keeps it maintainable.',
...
export const kickers: Record<string, string> = {
  ...
  'ux-engineer': 'Frontend systems · UX implementation · AI workflows',
  'frontend-ux-engineer': 'Frontend systems · Platform UX · AI workflows',
  'design-engineer': 'Design-in-code · Tokens & components · AI-augmented',
