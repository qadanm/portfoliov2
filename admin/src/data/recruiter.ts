...
export const recruiterPacks: Record<string, RecruiterPack> = {
  'product-designer': {
    shortIntro:
      'Product designer who ships. Recently designed and shipped three independent iOS products end to end — ChatOBD2, an AI-native diagnostics app; VINly, an AI used-car buyer report; and CarSpotter, a daily car-spotting game. Day job: UX lead across MagTek’s multi-site platform.',
    longIntro:
  ...
  'senior-product-designer': {
    shortIntro:
      'Senior product designer with end-to-end ownership. Founded and shipped three independent iOS products — ChatOBD2, an AI-native diagnostics app; VINly, an AI used-car buyer report; and CarSpotter, a daily car-spotting game. Lead UX and frontend systems for MagTek’s multi-site platform.',
    longIntro:
  ...
  'frontend-ux-engineer': {
    shortIntro:
      'Frontend UX engineer with platform depth. Shipped three React Native apps end to end — ChatOBD2 (Expo + RN, BLE, Supabase), VINly (Expo + RN, Supabase Edge Functions, multi-model AI), and CarSpotter (Expo + RN, Turborepo monorepo, shared design tokens). Lead frontend systems across MagTek’s multi-site platform.',
    longIntro:
  ...
  'design-engineer': {
    ...
    tellMeAboutYourself:
      'I describe myself as a design engineer because I don’t think of design and build as separate stages. Most of my work happens in code, against the components and tokens the product is actually built from. Recently I shipped three of my own iOS products: ChatOBD2, VINly, and CarSpotter, the last built on a shared token package that both the app and its website compile from. My day job is at MagTek, where I maintain a Razor partial library — over 100 typed, reusable components — and a token-driven CSS substrate that incrementally replaces page-specific markup across many properties. Earlier I was at InvestCloud doing high-fidelity Figma implementation across 50+ wealth and banking institutions. The thread is the same: design that survives the build.',
    whyImAFit: [
