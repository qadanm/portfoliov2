...
Diagnostic apps for cars are written by engineers for engineers. Codes, freeze frames, partial explanations, all surfaced raw. The driver staring at a screen is supposed to take all of that and produce a decision: drive it, don't drive it, fix it now, fix it later. Most of them give up and call a mechanic.
