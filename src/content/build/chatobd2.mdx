...
The model is one stage inside a structured pipeline, not the system. Its job is reducing complexity, not generating content.
...
Chat surface as the home screen. Verdict card as the unit of output. The model held as a constrained stage in the middle of a structured pipeline — structure on the input side, structure on the output side.
